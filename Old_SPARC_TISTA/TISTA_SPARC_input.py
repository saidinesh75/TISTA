...
class TISTA_NET(nn.Module): 
    ...
    def eval_tau2(self, t, i):  # error variance estimator
        v2 = (t.norm(2,1).pow(2.0) - n*sigma2)/taa
        v2.clamp(min=1e-9)
    ...
    def forward(self, x, s, max_itr):  # TISTA network
        ...
        y = x.mm(At) + torch.Tensor(torch.normal(0.0, sigma_std*torch.ones(batch_size, n))).to(device)
...
network_path = "/home/dinesh/Research_work/TISTA/TISTA_trained_models/TISTA_L12_N512" # gtdB_learnable means gamma, tau, delta and B are learnable
